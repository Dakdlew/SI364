...
"""
urlpatterns += [  
    path('author/create/', views.AuthorCreate.CreateView(), name='author_create'),
    path('author/<int:pk>/update/', views.AuthorUpdate.UpdateView(), name='author_update'),
    path('author/<int:pk>/delete/', views.AuthorDelete.CreateView(), name='author_delete'),
]
"""